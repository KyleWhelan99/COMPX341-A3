...
public class UserTest {
    ...
    public void getUserTypeTestCommunityType() {
         ...
         // Arrange
        User user = new User(); 
        int userType = UserType.community.getValue(); // UserType enumeration: 0 = encost unverified, 1 = encost verified, 2 = community
    ...
    public void getUserTypeTestEncostType() {
         ...
         // Arrange
        User user = new User(); 
        int userType = UserType.encostVerified.getValue(); // UserType enumeration: 0 = encost unverified, 1 = encost verified, 2 = community
    ...
    public void getUserTypeTestEncostUnverifiedType() {
         ...
         // Arrange
        User user = new User(); 
        int userType = UserType.encostUnverified.getValue(); // UserType enumeration: 0 = encost unverified, 1 = encost verified, 2 = community
